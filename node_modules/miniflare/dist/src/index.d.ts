...
export declare type Condition = BaseCondition | LogicalCondition;
...
export declare interface DispatchConnectOptions {
...
export declare type ErrorCode = "FLAG_NOT_FOUND" | "PARSE_ERROR" | "TYPE_MISMATCH" | "GENERAL";
...
export declare interface EvaluationDetails<T> {
    flagKey: string;
    value: T;
    variant: string;
...
export declare type EvaluationReason = "TARGETING_MATCH" | "DEFAULT" | "DISABLED" | "SPLIT" | "ERROR";
...
export declare interface Flag extends FlagInput {
    type: FlagType;
    updated_at: string;
}
...
export declare interface FlagInput {
    key: string;
    description?: string | null;
    enabled: boolean;
    default_variation: string;
...
export declare interface FlagshipAdmin {
    ...
    evaluateFlag(flagKey: string, context?: EvaluationContext): Promise<EvaluationDetails<FlagValue>>;
}

export declare type FlagType = "boolean" | "string" | "number" | "json";

export declare type FlagValue = boolean | string | number | Record<string, unknown> | unknown[];
...
export declare function getFlagshipService(appId: string, sharedOptions: Pick<ParsedInstanceOptions, "resourcePersistencePath" | "unsafeEnableSharedStorage">): ServiceDesignator_2;
...
export declare function isHeadersLike(value: unknown): value is Headers_3;
...
export declare interface LogicalCondition {
...
export declare class Miniflare {
     ...
     */
    dispatchConnect: (options?: DispatchConnectOptions) => Promise<net.Socket>;
    ...
    getFlagshipBindingAPI(bindingName: string, workerName?: string): Promise<() => FlagshipAdmin>;
...
export declare type Operator = "equals" | "not_equals" | "greater_than" | "less_than" | "greater_than_or_equals" | "less_than_or_equals" | "contains" | "starts_with" | "ends_with" | "in" | "not_in";
...
export declare interface Rollout {
    percentage: number;
    attribute?: string;
}
